...
import ScrollAnimator from '@enact/moonstone/Scroller/ScrollAnimator';
import Scrollbar from '@enact/moonstone/Scroller/Scrollbar';
import scrollbarCss from '@enact/moonstone/Scroller/Scrollbar.less';
import Spotlight, {getDirection} from '@enact/spotlight';
import SpotlightContainerDecorator from '@enact/spotlight/SpotlightContainerDecorator';

import css from './CoverFlowScrollable.less';
...
const
	...
	holdTime = 50,
	scrollWheelMultiplierForDeltaPixel = 1,
...
const CoverFlowScrollableHoC = hoc((config, Wrapped) => {
	return class CoverFlowScrollable extends Component {
		...
		start ({targetX, targetY, animate = true, silent = false, duration = animationDuration, indexToFocus, nodeToFocus}) {
			...
			// snap!
			targetX = Math.round(targetX / bounds.xSnap) * bounds.xSnap;
...
export default CoverFlowScrollableHoC;
export {dataIndexAttribute, CoverFlowScrollableHoC as CoverFlowScrollable};
