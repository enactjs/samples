...
import componentCss from './SandstonePopup.module.less';

const SandstonePopup = ({...rest}) => {
	...
	return (
		<Layout {...rest} className={componentCss.sandstonePopup} orientation="vertical">
			...
			<Row>
				...
				<Cell>
					<BodyText>Click below to open a Popup that has &apos;noAnimation&apos;, but applies smooth transitions using the new CSS features.</BodyText>
					<Button
