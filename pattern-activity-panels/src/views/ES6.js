				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							t.div,
							null,
							React.createElement(t.StatefulInput, { placeholder: 'Enter something', value: this.state.inputValue, onChange: this.updateInput}),
							React.createElement(t.StatefulInput, { placeholder: 'Enter Something', disabled: true })
						),
						React.createElement(
							t.Divider,
							null,
						...
						React.createElement(t.Slider, { min: 0, max: 100, value: 25, step: 1}),
						React.createElement(t.IncrementSlider, { min: 0, max: 100, value: 25, step: 1}),
						React.createElement(
							t.Divider,
							null,
							'Toggle Items'
